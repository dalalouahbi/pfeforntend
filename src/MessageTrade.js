              ...
              {/* <form className="needs-validation" noValidate> */}
                <div className="row">
                  <div className="col-md-6 mb-3">
                    ...
                    <input style={{width:"220px",marginRight:"240px"}} type="text" className="form-control" name="name"  defaultValue required />
                  ...
                  <div className="col-md-6 mb-3">
                    ...
                    <input type="text" style={{width:"220px",marginRight:"240px"}} className="form-control" name="prenom"  defaultValue required />
                ...
                <div className="mb-3">
                  ...
                  <input style={{marginRight:"250px",height:"45px",height:"45px",width:"754px"}} type="text" className="form-control" name="adress" placeholder="1234 Main St" required />
                  {/* <small className="text-danger"> {error["adress"]}</small> */}
                </div>
                <div className="mb-3">
                  <label htmlFor="address2">Address 2 <span className="text-muted">(Optional)</span></label>
                  <input style={{marginRight:"250px",height:"45px",height:"45px",width:"754px"}} type="text" className="form-control" name="adress2" placeholder="Apartment or suite" />
                </div>
                <div className="row">
                  <div className="col-md-5 mb-3">
                    <label htmlFor="country">Country</label>
                    <select className="custom-select d-block w-100" name="country"  required>
                     {city.map((u)=>{
                      return(
                  ...
                  <div className="col-md-3 mb-3">
                    ...
                    <input type="text" style={{width:"160px"}} className="form-control" name="codezip"  placeholder required />
                ...
                <hr className="mb-4" />
                <button className="btn btn-primary btn-lg btn-block" type="submit" ><a href='/'>Continue to checkout</a></button>
              {/* </form> */}
            </div>
          </div>
